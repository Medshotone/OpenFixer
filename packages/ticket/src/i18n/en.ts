export const dict = {
  ...
  "dialog.jira.title": "Jira Integration",
  "dialog.jira.url": "Jira URL",
  "dialog.jira.url.placeholder": "https://yourcompany.atlassian.net",
  "dialog.jira.email": "Email",
  ...
  "dialog.jira.enabled": "Enable polling",
  "dialog.jira.test": "Test Connection",
  "dialog.jira.test.success": "Connection successful",
  ...
  "dialog.teams.dm_user_ids": "DM-allowed users",
  "dialog.teams.dm_user_ids.help": "Users in this list can DM the bot about this project. IDs are AAD object GUIDs (not emails). Ask each user to type /id in their DM with the bot to get theirs.",
  "dialog.teams.dm_user_ids.placeholder": "e.g. 8a8b1c2d-...",
  "dialog.teams.dm_user_ids.add": "+ Add User",
  "dialog.teams.dm_user_ids.remove": "Remove",
  ...
  "dialog.teams.tenant_id.placeholder": "Optional — only for single-tenant bots",
  "dialog.teams.trigger_mode": "Trigger mode",
  "dialog.teams.trigger_mode.always": "Reply to every message",
  "dialog.teams.trigger_mode.mention": "Reply only when @mentioned",
  "dialog.teams.enabled": "Enable integration",
  ...
  "sidebar.project.teams": "Teams Settings",
